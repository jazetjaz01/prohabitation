...
import { 
  User, Mail, Phone, MessageSquare, Tag, MapPin, 
  MailCheck, PhoneCall, Loader2, Home, Maximize, Navigation
} from "lucide-react";
...
// 1. Définition stricte des types pour TypeScript et Zod
  ...
  return (
    <main className="min-h-screen bg-slate-200 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-slate-800 mb-8 uppercase tracking-tighter">Demande de Devis Gratuit</h1>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                <div className="space-y-8">
                  <h2 className="text-xl font-bold text-slate-800 uppercase tracking-wider border-b pb-2">1. Vos Coordonnées</h2>
                ...
                <div className="space-y-8">
                  <h2 className="text-xl font-bold text-slate-800 uppercase tracking-wider border-b pb-2">2. Votre Projet</h2>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            <SelectItem value="placo">Pose Placo / Cloisons</SelectItem>
                            <SelectItem value="peinture">Peinture intérieure</SelectItem>
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            ...
                            >
                              <div className="flex items-center space-x-2 bg-slate-50 p-2 border flex-1 justify-center cursor-pointer">
                  ...
                  <FormField control={form.control} name="message" render={({ field }) => (
                    <FormItem>
                      ...
                      <div className="relative">
                        ...
                        <FormControl>
                          <Textarea placeholder="Décrivez votre projet..." className="min-h-[120px] pl-10 pt-4 rounded-none bg-slate-50/50 border-slate-200" {...field} />
                        </FormControl>
                      </div>
                      <FormMessage />
                    </FormItem>
              ...
              <div className="flex justify-center md:justify-end pt-8">
                <Button 
                  ...
                  className="bg-teal-700 hover:bg-slate-800 text-white px-16 h-14 rounded-none transition-all uppercase font-bold tracking-widest flex items-center gap-3 text-lg"
                >
                  {isSubmitting ? <Loader2 className="animate-spin" /> : "Demander mon devis"}
                </Button>
              </div>
            </form>
          </Form>
