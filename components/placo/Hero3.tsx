          ...
          <div className="max-w-xl w-full">
            ...
            <div className="flex flex-col leading-tight mb-8">
              ...
              <p className="text-3xl md:text-4xl font-medium text-slate-800">
                <span className="font-pinyon text-5xl md:text-6xl">faux</span> plafonds 
              </p>
            </div>

            <div className="space-y-6 text-slate-600 text-lg leading-relaxed mb-10">
              <p>
                Embellissez et modernisez vos espaces intérieurs tout en améliorant l’acoustique et l’esthétique grâce à la pose de faux-plafonds élégants et fonctionnels. 
              </p>
              <p className="font-medium text-slate-800 border-l-4 border-teal-700 pl-4">
                Nous proposons une variété de matériaux pour répondre à vos besoins spécifiques, qu’ils soient esthétiques ou techniques.
              </p>
            </div>
